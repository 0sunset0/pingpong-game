package prography.pingpong_game.common.dto;
...
import static prography.pingpong_game.common.exception.ApiStatus.SUCCESS;
...
public record ApiResponse<T>(
    ...
    public static <T> ApiResponse<T> error(ApiStatus apiStatus) {
        return new ApiResponse<>(apiStatus.getHttpStatus().value(), apiStatus.getMessage(), Optional.empty());
    }
}
